...
class VerificationPageForgotPassword extends StatefulWidget {
  ...
  const VerificationPageForgotPassword({super.key, required this.userType, this.onTap});

  @override
  State<VerificationPageForgotPassword> createState() => _VerificationPageForgotPasswordState();
}

class _VerificationPageForgotPasswordState extends State<VerificationPageForgotPassword>
